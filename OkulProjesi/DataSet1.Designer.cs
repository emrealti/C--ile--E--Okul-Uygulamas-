...
namespace OkulProjesi {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DataTable1Row AddDataTable1Row(string OGRAD, string OGRSOYAD, string KULUPAD, string OGRCINSIYET, byte KULUPID) {
...
namespace OkulProjesi.DataSet1TableAdapters {
    ...
    public partial class TBLDERSLERTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [TBLDERSLER] WHERE (([DERSID] = @Original_DERSID) AND ([DERSAD] = @Or" +
                "iginal_DERSAD))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [TBLDERSLER] SET [DERSAD] = @DERSAD WHERE (([DERSID] = @Original_DERSID) A" +
                "ND ([DERSAD] = @Original_DERSAD));\r\nSELECT DERSID, DERSAD FROM TBLDERSLER WHERE " +
                "(DERSID = @DERSID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::OkulProjesi.Properties.Settings.Default.BonusOkulConnectionString;
        }
        ...
        public virtual int DersGüncelleme(string DERSAD, byte Original_DERSID) {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRSOYAD, TBLKULUPLER.KULUPAD, TBLOGRENCILER.OGRCINSIYET, TBLKULUPLER.KULUPID
FROM            TBLOGRENCILER INNER JOIN
                         TBLKULUPLER ON TBLOGRENCILER.OGRKULUP = TBLKULUPLER.KULUPID";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT        TBLOGRENCILER.OGRID, TBLOGRENCILER.OGRAD, TBLOGRENCILER.OGRSOYAD, TBLKULUPLER.KULUPAD, TBLOGRENCILER.OGRCINSIYET, TBLKULUPLER.KULUPID, TBLOGRENCILER.OGRKULUP
FROM            TBLOGRENCILER INNER JOIN
                         TBLKULUPLER ON TBLOGRENCILER.OGRKULUP = TBLKULUPLER.KULUPID
WHERE        (TBLOGRENCILER.OGRID = @OGRID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual int FillBy(DataSet1.DataTable1DataTable dataTable, int OGRID) {
        ...
        public virtual DataSet1.DataTable1DataTable OgrenciGetir(int OGRID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(OGRID));
            DataSet1.DataTable1DataTable dataTable = new DataSet1.DataTable1DataTable();
            this.Adapter.Fill(dataTable);
